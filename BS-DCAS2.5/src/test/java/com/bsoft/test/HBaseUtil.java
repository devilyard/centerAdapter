...
public class HBaseUtil {
    ...
    public static Configuration getConfiguration(){
    	HbaseTemplate HTemplate = (HbaseTemplate) appContext.getBean("htemplate");
     ...
     * @throws IOException
     */
    public static ResultScanner getResultScanner(String tableName,String columnFamily,String qualifier,String queryCondition,String begin,String end) throws IOException{
...
//        scan.addColumn(Bytes.toBytes(columnFamily),null);
        ...
        Filter filter1 = new SingleColumnValueFilter(Bytes.toBytes(columnFamily),Bytes.toBytes(qualifier),CompareOp.EQUAL,Bytes.toBytes(queryCondition));
